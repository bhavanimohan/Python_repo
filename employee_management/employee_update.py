...
def update_emp():
    ...
    user_selection= int(input("Enter the id that you wanna update : "))
    if user_selection == 1:
        id = int(input("Enter the id that you wanna update : "))
        to_update_name = input("Enter the name that you wanna update it : ")
        query = "update emps set name = %s where id = %s",to_update_name,id
        
    elif user_selection == 2:
        id = int(input("Enter the id that you wanna update : "))
        to_update_age = int(input("Enter the age that you wanna update it : "))
        query = "update emps set age = %s where id = %s",to_update_age,id
    elif user_selection == 3:
        id = int(input("Enter the id that you wanna update : "))
        to_update_salary = float(input("Enter the salary that you wanna update it : "))
        query = "update emps set salary = %s where id = %s",to_update_salary,id
    elif user_selection == 4:
        id = int(input("Enter the id that you wanna update : "))
        to_update_location = input("Enter the location that you wanna update it : ")
        query = "update emps set location = %s where id = %s",to_update_location,id
