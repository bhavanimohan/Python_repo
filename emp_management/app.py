...
while True:
    ...
    if option == "1":
        get_all_emps()
    if option == "2":
        name_to_insert=input("Enter the id where you wanna insert : ")
        ...
        inserting(name_to_update,age_to_insert,salary_to_insert,location_to_insert)
    if option == "3":
        name_to_update = input("Enter the name that you wanna update it : ")
        name_to_replace = input("Enter the name where you wanna update it : ")
        update_emp(name_to_update,name_to_replace)
    if option == "4":
