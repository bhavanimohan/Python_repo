...
# print(200 in a) #this IN method returns only true or false if the given element is present in the given list then it returns true otherwise false 
# print(5 in a)

a = ["hello", "This","is","bhavani","mohan", 1,2,3]
b = []
for char in a:
    b.append(char)
...
a = ["hello", 10, "world", 25, 3.5, "python"]
count = []
