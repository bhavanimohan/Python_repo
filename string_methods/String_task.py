...
a = " pYtHoN Is AwEsOmE "
a = a.strip().title().replace(" ", "_").replace("Is", "is")
print(a)
...
a=" welcome TO python FULL stack "
a=a.strip().title().replace("To","to")
print(a)

a=" Learn Python In 30 Days "
# strip(), upper(), split(), reverse words, join("->")
# -> days_30_in_python_learn
a="_".join(a.strip().lower().split()[::-1])
print(a)
...
a="_".join(a.strip().swapcase().title().lower().replace("python","java").split()[::-1])
print(a)